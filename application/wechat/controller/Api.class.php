...
use app\wechat\controller\Utils\HttpCurl;
include 'D:\PHP\wx\application\wechat\controller\Utils\HttpCurl.class.php';
use app\xczx\controller\Utils\Error;
use app\xczx\controller\Utils\SHA1;
use app\xczx\controller\Utils\Xml;
...
class Api 
{
     ...
     * Examples:
     * ```
     * $api->get_authorize_url('snsapi_base', 'http://Gaoming13.diary8.com/demo/snsapi/callback_snsapi_base.php');
     * $api->get_authorize_url('snsapi_userinfo', 'http://Gaoming13.diary8.com/demo/snsapi/callback_snsapi_userinfo.php');
     * ```
     *
